<footer class="flex flex-col py-12 items-center bg-black text-white">
    ...
    <a href="https://goo.gl/maps/hruVS5xHAXjfkwqy6" class="no-underline text-white text-center text-lg type-a2 mt-12">{{ trans('homepage.footer.address') }}</a>
    <a href="mailto:{{ trans('homepage.footer.email') }}" class="no-underline text-white hover:text-gold text-lg type-a2 mt-2">{{ trans('homepage.footer.email') }}</a>
{{--    <a href="mailto:info@loherb.com.tw" class="no-underline text-white hover:text-gold text-lg type-a2 mt-2">info@loherb.com.tw</a>--}}
    <a href="tel:{{ trans('homepage.footer.phone') }}" class="no-underline text-white text-lg type-a2 mt-2">{{ trans('homepage.footer.phone') }}</a>
    ...
    <div class="flex justify-center mt-8">
        <a class="type-a2 text-white mx-6 uppercase no-underline hover:text-gold" href="https://villa.loherb.com.tw">{{ trans('homepage.nav.villa') }}</a>
        <a class="type-a2 text-white mx-6 uppercase no-underline hover:text-gold" href="https://cuisine.loherb.com.tw">{{ trans('homepage.nav.cuisine') }}</a>
        <a class="type-a2 text-white mx-6 uppercase no-underline hover:text-gold" href="https://estate.loherb.com.tw">{{ trans('homepage.nav.estate') }}</a>
        <a class="type-a2 text-white mx-6 uppercase no-underline hover:text-gold" href="https://patisserie.loherb.com.tw">{{ trans('homepage.nav.patisserie') }}</a>
    </div>
</footer>
