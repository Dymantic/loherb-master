<nav class="absolute top-0 left-0 w-full h-12 flex justify-center items-center z-40 main-nav type-a1 bg-black-opq">
    ...
    <a href="{{ transUrl(request()->path()) }}" class="hover:text-gold text-sm md:text-lg text-white uppercase no-underline right-0 static md:absolute mr-4 ml-4 md:ml-0 md:mr-8">{{ trans('homepage.nav.language') }}</a>
</nav>
