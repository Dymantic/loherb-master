...
<section class="banner relative px-8 flex flex-col justify-center items-center font-sans relative">
    ...
    <h1 class="text-3xl md:text-5xl text-white text-center font-heading relative z-40">Welcome to the Loherb Group.</h1>
    ...
    <section class="py-20 px-8 flex flex-col items-center">
        ...
        <p class="mt-20 font-serif text-lg text-center max-w-md my-8 mx-auto">{{ trans('homepage.intro.part_one') }}</p>
        <p class="font-serif text-lg text-center max-w-md my-8 mx-auto">{{ trans('homepage.intro.part_two') }}</p>
    </section>
    <section>
    ...
    <footer class="flex flex-col py-12 items-center bg-black text-white">
        ...
        <p class="text-lg font-heading mt-2">{{ trans('homepage.footer.email') }}</p>
        <p class="text-lg font-heading mt-2">{{ trans('homepage.footer.phone') }}</p>
